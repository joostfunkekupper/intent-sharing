package com.example.sharedtokenspikeapp1;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TARGET_PACKAGE_NAME = "com.example.sharedtokenspikeapp2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Register our BroadcastReceiver with a unique name
        this.registerReceiver(tokenResponseReceiver, new IntentFilter("com.example.sharedtokenspikeapp1.TokenResponseReceiver"));
